...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        'disk' => env('LIVEWIRE_TEMPORARY_FILE_UPLOAD_DISK', 'local'), // Pinned to 'local' so browser previews load via Livewire's built-in route (not MinIO internal hostname).
    ...
    */
    ...
    'payload' => [
        ...
        'max_components' => 200,        // Maximum components per batch request (raised from 20 to support pages with many list items)
    ],
];
