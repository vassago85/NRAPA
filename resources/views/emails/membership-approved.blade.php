...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #eff6ff; border: 1px solid #93c5fd; border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center;">
        ...
        <a href="{{ $cardUrl }}" style="display: inline-block; background: linear-gradient(135deg, #10b981, #047857); color: white; padding: 12px 30px; border-radius: 8px; text-decoration: none; font-weight: bold;">View My Card</a>
    </div>
    ...
    <ul style="color: #4b5563; padding-left: 20px;">
        ...
        <li style="margin-bottom: 8px;"><strong>Virtual Safe</strong> – Register your firearms in your Virtual Safe for easy endorsement applications.</li>
