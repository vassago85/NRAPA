...
<div class="space-y-6">
    ...
    {{-- SAPS 271 Fields Section --}}
    <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6">
        <h3 class="text-lg font-semibold text-zinc-900 dark:text-white mb-4">SAPS 271 Firearm Description</h3>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                @if($firearmType === 'other')
                    <input 
                        type="text"
                        wire:model="firearmTypeOther"
                        placeholder="e.g., Hand Machine Carbine, Armament, etc."
                        class="w-full mt-2 px-4 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white"
                    />
                    <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">Specify armament or indeterminable design type</p>
                @endif
            </div>
            ...
            <div>
                ...
                <textarea 
                    wire:model="engravedText"
                    rows="2"
                    placeholder="Enter engraved text if applicable..."
                    class="w-full px-4 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white"
                ></textarea>
            </div>
        </div>
