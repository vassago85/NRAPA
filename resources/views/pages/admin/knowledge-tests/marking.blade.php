...
<div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Marking Queue</h1>
                <p class="text-zinc-600 dark:text-zinc-400">Review and mark written test answers.</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-4 sm:grid-cols-3">
        ...
        <div class="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
            ...
            <p class="mt-1 text-2xl font-bold text-green-600 dark:text-green-400">{{ $this->stats['passed_today'] }}</p>
        </div>
    </div>
        ...
        <div class="divide-y divide-zinc-200 dark:divide-zinc-700">
            ...
            <div class="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('admin.knowledge-tests.mark-attempt', $attempt) }}" wire:navigate class="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600">
                        Mark
                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
