...
<div x-data="{
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
        ...
        <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-800">
            <p class="text-xs font-medium uppercase tracking-wider text-yellow-600 dark:text-yellow-400">Pending</p>
            <p class="mt-2 text-3xl font-bold text-yellow-700 dark:text-yellow-300">{{ number_format($stats['pending']) }}</p>
        </div>
        <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-800">
        ...
        <div class="rounded-xl border-2 {{ $stats['lifetime_percent'] > 30 ? 'border-red-300 bg-red-50 dark:border-red-700 dark:bg-red-900/20' : ($stats['lifetime_percent'] > 15 ? 'border-amber-300 bg-amber-50 dark:border-amber-700 dark:bg-amber-900/20' : 'border-emerald-300 bg-emerald-50 dark:border-emerald-700 dark:bg-emerald-900/20') }} p-5">
            ...
            <table class="w-full">
                <thead class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900/50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-right text-xs font-medium uppercase tracking-wider text-yellow-600 dark:text-yellow-400">Pending</th>
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    ...
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-900/50">
                        ...
                        <td class="whitespace-nowrap px-4 py-4 text-right text-sm text-yellow-600 dark:text-yellow-400">{{ number_format($row['pending']) }}</td>
                ...
                <tfoot class="border-t-2 border-zinc-300 bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-900/50">
                    <tr>
                        ...
                        <td class="whitespace-nowrap px-4 py-4 text-right text-sm font-bold text-yellow-600 dark:text-yellow-400">{{ number_format($totals['pending']) }}</td>
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                @php
                    ...
                    $colors = match($source['raw']) {
                        ...
                        default => ['bg' => 'bg-zinc-500', 'text' => 'text-zinc-700 dark:text-zinc-300', 'light' => 'bg-zinc-100 dark:bg-zinc-900/30', 'border' => 'border-zinc-200 dark:border-zinc-700'],
                    };
                @endphp
