<x-layouts::auth>
    <div class="flex flex-col gap-6">
        <div class="text-center">
            ...
            <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">{{ __('Enter your email or phone number and password below to log in') }}</p>
        </div>
        ...
        <form method="POST" action="{{ route('login.store') }}" class="flex flex-col gap-4">
            ...
            <!-- Email or Phone -->
            <div>
                <label for="email" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">{{ __('Email or phone number') }}</label>
                <input 
                    type="text" 
                    name="email" 
                    id="email"
                    ...
                    placeholder="email@example.com or 082 123 4567"
