...
new class extends Component {
    ...
    public function saveStorageSettings(): void
    {
        ...
        SystemSetting::set('r2_url', $this->r2_url, 'string', 'storage', 'R2 Public URL');
                ...
                <form wire:submit="saveStorageSettings" class="space-y-6">
                    ...
                    <div class="pt-4 border-t border-zinc-200 dark:border-zinc-700 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="r2_bucket" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Bucket Name</label>
                            ...
                            <div class="md:col-span-2">
                                <label for="r2_url" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Public URL (Optional)</label>
                                <input type="url" id="r2_url" wire:model="r2_url" placeholder="https://storage.yourdomain.com"
                                    class="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
                                <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">Custom domain for public file access (if configured)</p>
                                @error('r2_url') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                            </div>
                        </div>
                    </div>
                    @endif
