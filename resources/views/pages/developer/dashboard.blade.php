...
<div>
    <x-slot name="header">
        <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Developer Dashboard</h1>
        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">System diagnostics, tools, and developer utilities</p>
    </x-slot>
