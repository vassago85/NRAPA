...
<div>
    <x-slot name="header">
        <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Nominate Owner</h1>
        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Nominate a new platform owner</p>
    </x-slot>
