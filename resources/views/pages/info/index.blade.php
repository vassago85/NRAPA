...
@section('content')
    ...
    <div class="not-prose grid gap-4 sm:grid-cols-2">
        <a href="{{ route('info.shooting-exercises') }}" class="group flex items-start gap-4 rounded-xl border border-zinc-200 bg-white p-5 shadow-sm transition hover:border-nrapa-blue/30 hover:shadow-md dark:border-zinc-700 dark:bg-zinc-800 dark:hover:border-nrapa-blue/50">
            ...
            <div>
                <p class="font-semibold text-zinc-900 group-hover:text-nrapa-blue dark:text-white dark:group-hover:text-nrapa-blue transition">Shooting exercises &amp; activities</p>
                <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Types of shooting exercises that count towards dedicated status requirements.</p>
            </div>
        </a>
    </div>
