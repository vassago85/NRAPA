...
@section('content')
    ...
    <ul>
        <li>Must undergo prescribed tests: Knowledge of FCA (Unit Standard 117705), plus practicals (Handgun 119649, Rifle 119651, Self-loading 119650, Shotgun 119652) at an accredited training provider</li>
        ...
        <li><strong>Supporting documents:</strong> 3 certified ID copies, 2 certified copies of competency certificates plus Statement of Results, 2 passport photos (neutral background, not older than 3 months)</li>
    </ul>

    <h2>Licensing Process</h2>
    <p>After obtaining SAPS Competency Certificate:</p>
    <ul>
        <li>Complete SAPS 271 form</li>
        <li>Submit to DFO with supporting documents:
            <ul>
