...
new #[Title('Dashboard')] class extends Component {
    ...
    {
        // Any membership awaiting payment: a new application (applied + reference)
        // OR a type change/upgrade (pending_payment). Excludes already-confirmed.
        // This must surface even when the member already has an active membership
        // (e.g. an upgrade from Basic to a Dedicated type).
