...
<div>
    ...
    <div class="mb-6 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-4">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                @if(isset($activityPeriod['deadline_label']))
                    <p class="text-xs text-blue-600 dark:text-blue-400 mt-1">{{ $activityPeriod['deadline_label'] }}</p>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div class="rounded-xl bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 p-4">
    ...
    <div class="overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800">
        @if($activities->isEmpty())
            <div class="p-8 text-center">
                ...
                <a href="{{ route('activities.submit') }}" wire:navigate class="mt-4 inline-flex items-center gap-2 text-emerald-600 hover:text-emerald-700 transition-colors">
                            ...
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-700/50">
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    @if($activity->status === 'approved')
                                        <span class="inline-flex items-center gap-1 rounded-full bg-emerald-100 dark:bg-emerald-900/40 px-2.5 py-0.5 text-xs font-medium text-emerald-800 dark:text-emerald-300">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-right text-sm">
                                    <a href="{{ route('activities.show', $activity) }}" wire:navigate class="text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 transition-colors">View</a>
                                    @if($activity->status === 'pending')
                                        <a href="{{ route('activities.edit', $activity) }}" wire:navigate class="ml-4 text-zinc-600 hover:text-zinc-700 dark:text-zinc-400 transition-colors">Edit</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
