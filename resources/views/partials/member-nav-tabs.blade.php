@php
    ...
    $inactive = 'border-transparent text-zinc-600 hover:text-zinc-900 hover:border-zinc-400 dark:text-zinc-400 dark:hover:text-zinc-200';
@endphp

@if($membership)
<nav class="flex flex-wrap border-b border-blue-200/50 dark:border-zinc-700 -mb-4 mt-3">
    {{-- Dashboard --}}
