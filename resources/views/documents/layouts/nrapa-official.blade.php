...
<head>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .far-banner {
            width: 66%;
            background: linear-gradient(90deg, #dce6f2 0%, #fde8d0 100%);
        ...
        /* Components card */
        .components-card { margin-top: 4px; padding: 8px 12px; width: 95%; margin-left: auto; margin-right: auto; background: rgba(255, 255, 255, 0.6); }
