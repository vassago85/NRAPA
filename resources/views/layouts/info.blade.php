    ...
    <body class="min-h-screen bg-white text-zinc-900 antialiased dark:bg-zinc-900 dark:text-zinc-100">
        ...
        <main class="mx-auto max-w-4xl px-6 py-12 lg:px-8">
            ...
            <div class="mb-8 flex flex-wrap gap-2 rounded-xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-700 dark:bg-zinc-800">
                ...
                <a href="{{ route('info.prs-rifle-equipment-selection') }}" class="rounded-lg px-3 py-1.5 text-sm font-medium transition {{ request()->routeIs('info.prs-rifle-equipment-selection') ? 'bg-nrapa-blue text-white' : 'text-zinc-600 hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-700' }}">PRS equipment guide</a>
            </div>
