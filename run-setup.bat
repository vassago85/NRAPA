...
if "%PHP_PATH%"=="" (
    ...
    if %errorlevel%==0 (
        ...
        echo Please ensure PHP is in your PATH or Laragon is installed.
        echo.
        echo You can also run these commands manually in Laragon terminal:
        echo   php artisan migrate --force
        echo   php artisan nrapa:import-firearm-reference
